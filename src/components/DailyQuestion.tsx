...
export default function DailyQuestion() {
    ...
    return (
        <motion.div
            ...
            className="glass-morphism rounded-[3rem] p-8 md:p-12 border-none shadow-2xl shadow-primary/10 relative overflow-hidden group"
        >
                ...
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Günün Modülü</span>
                            <span className="text-sm font-black text-foreground/40">{question.subjectName}</span>
                        </div>
                    </div>
                </div>

                <h3 className="text-3xl md:text-4xl font-black text-foreground mb-12 leading-tight max-w-2xl">
                    {question.text}
                </h3>
                ...
                <AnimatePresence>
                    {showResult && (
                        <motion.div
                            ...
                            className="mt-12 flex flex-col lg:flex-row items-center justify-between gap-8 p-8 bg-foreground/5 rounded-[2.5rem] border border-border-theme/40 backdrop-blur-3xl"
                        >
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-foreground/50 font-bold">
                                        {selected === question.correctOption
                                            ? "Doğru cevabı buldun ve laboratuvar kredisi kazandın."
                                            : "Doğru cevap teknik olarak şuydu: " + question.options[question.correctOption]}
                                    </p>
                                </div>
                            </div>

                            <div className="flex items-center gap-4 w-full lg:w-auto">
                                <div className="px-6 py-4 bg-primary/10 rounded-2xl border border-primary/20 flex-1 lg:flex-none text-center">
                                    <span className="text-[10px] font-black uppercase text-primary block mb-1">Ödül</span>
                                ...
                                <button
                                    ...
                                    className="p-6 bg-foreground text-background dark:bg-white dark:text-black rounded-2xl font-black hover:scale-105 active:scale-95 transition-all shadow-xl flex-1 lg:flex-none"
                                >
